...
class CartViewModelFactory(private val repository: Repository, private val cart: Cart) :
    ViewModelProvider.Factory {

    override fun <T : ViewModel?> create(modelClass: Class<T>) =
        with(modelClass) {
            when {
                isAssignableFrom(CartViewModel::class.java) -> CartViewModel(repository, cart)
